...
Sprite * Sprite::Create(UINT texNumber, Math::Vector2 position, XMFLOAT4 color, Math::Vector2 anchorpoint, bool isFlipX, bool isFlipY)
{
	// 仮サイズ
...
Sprite::Sprite(UINT texNumber, Math::Vector2 position, Math::Vector2 size, XMFLOAT4 color, Math::Vector2 anchorpoint, bool isFlipX, bool isFlipY)
{
