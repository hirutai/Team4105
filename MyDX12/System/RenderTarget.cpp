...
{
	auto d3dDevice = DirectX12::GetDevice();
	m_width = w;
	m_height = h;
...
bool RenderTarget::CreateDescriptorHeap(ID3D12Device*& d3dDevice)
{
	...
	desc.NumDescriptors = DirectX12::FRAME_BUFFER_COUNT;
...
)
{
	...
	m_renderTargetTexture.TexInitFromD3D_RESOURCE(m_renderTargetTextureDx12);
	return true;
}
