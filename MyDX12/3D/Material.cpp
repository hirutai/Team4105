...
void Material::LoadTexture(Texture texture, CD3DX12_CPU_DESCRIPTOR_HANDLE cpuHandle, CD3DX12_GPU_DESCRIPTOR_HANDLE gpuHandle)
{
	HRESULT result;
	cpuDescHandleSRV = cpuHandle;
	gpuDescHandleSRV = gpuHandle;
	Texture albd;
	albd.TexInitFromD3D_RESOURCE(texture.Get());
	texbuff = albd.Get();
