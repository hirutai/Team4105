...
private:
	// 頂点数
	static const int vertNum = 24;// 4(1面の頂点数) * 6(面)
...
public: // 静的メンバ関数
	...
	static CollisionBox* Create(const Math::Vector3& start, const Math::Vector3& end);

public:
	/// <summary>
	/// コンストラクタ
	/// </summary>
	CollisionBox(const Math::Vector3& start, const Math::Vector3& end);
